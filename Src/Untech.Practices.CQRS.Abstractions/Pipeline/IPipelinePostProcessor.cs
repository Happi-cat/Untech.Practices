...
{
	/// <summary>
	/// Defines a pipeline step that will be triggered after <see cref="IRequestHandler{TIn,TOut}"/> or <see cref="IRequestAsyncHandler{TIn,TOut}"/>
	/// </summary>
	...
	public interface IPipelinePostProcessor<in TRequest, in TResponse>
	{
		...
		/// <param name="response"><see cref="IRequest{TResult}"/> execution response.</param>:w
