...
namespace Untech.Practices.CQRS
{
	...
	public struct None : IEquatable<None>, IComparable<None>, IComparable
	{
		...
		/// <summary>
		///     Default task with value of the <see cref="None" /> type.
		/// </summary>
		public static readonly Task<None> AsTask = Task.FromResult(Value);
		...
		/// <c>false</c>
		/// .
		public static bool operator ==(None first, None second)
		{
			return true;
		}
